...
print("Mean, median and mode for weight is {}, {}, {}".format(weight_mean,weight_median,weight_mode))
...
height_list_of_data_within_3_std_deviation = [result for result in height_list if result > height_third_std_deviation_start and result < height_first_std_deviation_end]
